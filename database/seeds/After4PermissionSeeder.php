...
class After4PermissionSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $data = [
            "Lazada - Sponsored Product" => [
                ["View Campaign, Products, Keywords", "M_LZD_SP_VIEW_CPK", ""],
                ["Edit/Create Campaign, Products, Keywords", "M_LZD_SP_EDIT_CPK", "View Campaign, Products, Keywords"],
                ["Add/Create Rules to Products, Keywords", "M_LZD_SP_EDIT_RULE", "Edit/Create Campaign, Products, Keywords"],
                ["Download selected Objects", "M_LZD_SP_DOWNLOAD", "View Campaign, Products, Keywords"],
            ],
        ];
